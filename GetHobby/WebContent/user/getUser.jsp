...
/* 	var totalChecked = $("input[type='checkbox']:checked").length; */
	...
	function CountChecked(field){			
		...
		if(field.checked){
			if($("input[type='checkbox']:checked").length > maxCheck){
				Swal.fire({
					  icon: 'warning',
	...
	function fncupdateUser(){
		...
		Swal.fire({
					  ...
					  timer: 800
						...
						$("form#updateUserInfoSend").attr("method","POST").attr("action","/user/updateUser").submit();
					})
...
/////////////////validation check/////////////
		...
		hashtaglist = hashtaglist3.split(',');
		var hashtagleng = $("input[type='checkbox']").length;
		 for(var i=0; i<hashtagleng; i++){
					...
					<div class="sc-eerKOB inUTcFFF">
						<div class="sc-eilVRo QtLBlll">
							<div class="sc-gHboQg bXUojH" style="margin-top: 60px;">
								<h1>내 정보 관리</h1>
								<form id="updateUserInfoSend" enctype="multipart/form-data" >
									 ...
									 <div class="Profile__EditProfileImageWrapper-sc-1sl3brv-1 cRNLYZ">
										  <label class="S3UploadButton__Container-a68j44-0 logKjs">
											  ...
											  <input type="hidden" id="beforefile" name="beforefile" value="${user.profileImage}">
											  <div size="88" class="ProfileImageUploadHandler__Container-sc-1advxtt-0 jLGbZG">
												  <div size="88" class="ProfileImage__Container-sc-1h9kedz-0 kgaAUr">
													  <span class="RatioImage__Container-wwqqoo-0 eAfAEc ProfileImage__UserProfileImage-sc-1h9kedz-1 bKTweb">
													 	 <img  src="../resources/image/woo/${user.profileImage}" alt="" class="RatioImage__Img-wwqqoo-1 gRslZu" id="image_section">
													  </span>
												  </div>
									...
									<div class="sc-kIPQKe gNPcmC RegisterPage__StyledFormGroup-sc-1vwt6wy-2 hGLglh">
										<label class="sc-esjQYD cvzQqA">이름
											...
											<input class="sc-epnACN cNSGNe" type="text" name="name" id="name" placeholder="홍길동" autocomplete="off" value="${user.name}">
									 ...
									 <div class="sc-kIPQKe gNPcmC RegisterPage__StyledFormGroup-sc-1vwt6wy-2 hGLglh">
										<label class="sc-esjQYD cvzQqA">생년월일 (8자리)
											...
											<div class="sc-iQNlJl bdbgMM">
											<input class="sc-epnACN cNSGNe   " type="text" name="birth" id="birth" placeholder="생년월일" autocomplete="off" value="${user.birth }" maxlength="8">
									...
									<div class="sc-kIPQKe gNPcmC RegisterPage__StyledFormGroup-sc-1vwt6wy-2 hGLglh">
										<label class="sc-esjQYD cvzQqA">휴대전화 번호
											...
											<div class="sc-iQNlJl bdbgMM">
											<input class="sc-epnACN cNSGNe   " type="text" name="phone" id="phone" placeholder="-를 제외한 휴대폰 번호를 입력해주세요" autocomplete="off" value="${user.phone }">
									...
									<div class="sc-kIPQKe gNPcmC RegisterPage__StyledFormGroup-sc-1vwt6wy-2 hGLglh">
										<label class="sc-esjQYD cvzQqA">닉네임
											...
											<div class="sc-iQNlJl bdbgMM">
											<input class="sc-epnACN cNSGNe   " type="text" name="nickName" id="nickName" placeholder="홍길동" autocomplete="off" value="${user.nickName }">
								...
								<label class="sc-esjQYD cvzQqA"> 관심사 선택(최대5개)</label><br>
									...
									<div class="carousel-item" style="text-align:center;">
									 ...
									 <div class="form-group">
										    ...
										    <div >
										      <input type="text" class="aDress" id="postCode" name="postCode" style="float:left" placeholder="우편번호" value="${user.postCode }">
										      ...
										      <input type="text" class="cNSGNe" id="address" name="address" placeholder="주소" value="${user.address}"><br>
										      <input type="text" class="cNSGNe" id="detailAddress" name="detailAddress" placeholder="상세주소"  value="${user.detailAddress}">
										     </div>										      
											...
											<hr>					
									<button type="button" class="sc-jTzLTM flMyeK sc-kEYyzF eYKibL RegisterPage__SignUpButton-sc-1vwt6wy-3 kVAMqa" id="updateUsersubmit" color="orange" fill="true" style="margin-top: 40px;">
										<span class="sc-fjdhpX kCztpU">수 정</span>
									</button>
								</form>
							</div>
						</div>
