...
<body id="bootstrap-overrides" class="shc-body">
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$(document).on("mouseleave",".btn-dark", function(){
			...
			////////////////////////////// Next Button 활성화/비활성화 : 작성이 모두 완료된 상태라면 활성화  Start //////////////////////////////
			var progress = 0; // 진행바 진행률 변수
			...
			if( $("select[name='hobbyClassCategory']").val() != "" && $("select[name='hobbyClassCategory']").val() != null
				...
				progress += 30;
				$('#infoNoButton').css({'display':'none'}); // 클래스 기본정보 비활성화 다음 버튼 숨기기
	            $('#infoYesButton').css({'display':'inline-block'}); // 클래스 기본정보 비활성화 다음 버튼 나타내기
			...
			//////////////////////////////Next Button 활성화/비활성화 : 작성이 모두 완료된 상태라면 활성화  End //////////////////////////////	
			
			
			// (변화, 입력, 복사, 잘라내기, 붙여넣기) 이벤트 : Next Button 활성화 비활성화 : 작성이 모두 완료된 상태라면 활성화 ==> 사용자가 사용 중일 때
			$(document).on("change input copy cut paste", function(){		
			...
			$(document).on("click", "a[href='#hobbyClassInfo']", function(){
				
				
			});
			$(document).on("click", "a[href='#hobbyClassLesson']", function(){
				
				
			});
			$(document).on("click", "a[href='#hobbyClassKit']", function(){
