            ...
            <div class="form-row my-3">
                <div class="input-group col-lg-3">
                    <select class="form-control" name="articleType">
                        ...
                        <c:choose>
					         <c:when test = "${article.articleType.equals('001')}">
					          	  <option value="001" selected>꿀팁</option>
					          	  <option value="002">잡담</option>
								  <option value="003">질문</option>
					         </c:when>
					         <c:when test = "${article.articleType.equals('002')}">
					         	  <option value="001">꿀팁</option>
					          	  <option value="002" selected>잡담</option>
					          	  <option value="003">질문</option>
					         </c:when>
					         <c:when test = "${article.articleType.equals('003')}">
					         	  <option value="001">꿀팁</option>
					          	  <option value="002">잡담</option>
					          	  <option value="003" selected>질문</option>
					         </c:when>
				    	</c:choose>
                    </select>
                </div>
                <div class="input-group col-lg-9">
                    <input type="text" class="form-control" name="articleTitle" placeholder="게시글 제목을 입력하세요" value="${ article.articleTitle }">
                </div>
            </div>
